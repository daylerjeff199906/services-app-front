...
export function DashboardPage() {
  ...
  return (
    <div className="space-y-6 text-foreground">
      {/* Welcome Banner */}
      <div className="bg-card border border-border p-6 rounded-xl shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {metrics.map((metric) => (
          <div key={metric.name} className="p-6 bg-card border border-border rounded-xl shadow-sm">
