      ...
      <main className="flex-1 space-y-24 py-16">
        ...
        <section id="beneficios" className="container mx-auto px-8 space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-3xl font-extrabold tracking-tight">Todo lo que necesitas para crecer online</h2>
            ...
            <div className="p-8 lg:p-12 lg:col-span-7 space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-extrabold text-[#059669]">${servicePrice} USD</span>
                </div>
                <input
                  type="range"
                  min="10"
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-extrabold text-[#059669]">{monthlyJobs} servicios</span>
                </div>
                <input
                  type="range"
                  min="5"
            ...
            <div className="bg-[#059669] text-white p-8 lg:p-12 lg:col-span-5 flex flex-col justify-between space-y-8">
              <div className="space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <span className="text-3xl font-extrabold">${totalRevenue.toLocaleString()} USD</span>
                </div>
              ...
              <div className="bg-white/10 p-4 rounded-lg space-y-1">
                ...
                <span className="text-2xl font-extrabold text-white">+${monthlySavings.toLocaleString()} USD</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-8">
          <div className="bg-[#059669] text-white p-8 md:p-16 rounded-2xl text-center space-y-6 relative overflow-hidden">
            ...
            <div className="pt-4">
              <Link
                to={isAuthenticated ? "/services" : "/register"}
                className="inline-block py-3.5 px-8 bg-white text-black hover:bg-gray-100 font-extrabold rounded-lg shadow-lg transition-all text-base"
              >
