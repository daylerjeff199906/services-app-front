    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col justify-between font-sans transition-colors duration-200">
      ...
      <section className="relative py-20 overflow-hidden border-b border-border bg-muted/10">
        ...
        <div className="container mx-auto px-8 relative z-10 flex flex-col items-center text-center space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl  tracking-tight max-w-4xl leading-tight">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
            <Link
              ...
              className="w-full sm:w-auto py-3 px-8 bg-[#059669] text-white hover:bg-[#047857]  rounded-lg shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 text-base"
            >
      ...
      <main className="flex-1 space-y-24 py-16">
        ...
        <section id="beneficios" className="container mx-auto px-8 space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-3xl  tracking-tight">Todo lo que necesitas para crecer online</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6 bg-card border border-border rounded-xl shadow-sm space-y-4 hover:border-primary/50 transition-colors">
              ...
              <h3 className="text-lg ">Agenda Inteligente</h3>
            ...
            <div className="p-6 bg-card border border-border rounded-xl shadow-sm space-y-4 hover:border-primary/50 transition-colors">
              ...
              <h3 className="text-lg ">Pagos Seguros</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="p-6 bg-card border border-border rounded-xl shadow-sm space-y-4 hover:border-primary/50 transition-colors">
              ...
              <h3 className="text-lg ">Cartera de Ofertas</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="p-6 bg-card border border-border rounded-xl shadow-sm space-y-4 hover:border-primary/50 transition-colors">
              ...
              <h3 className="text-lg ">Control de Clientes</h3>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="bg-card border border-border rounded-2xl shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="p-8 lg:p-12 lg:col-span-7 space-y-8">
              <div className="space-y-2">
                <span className="text-xs  uppercase tracking-wider text-[#059669]">Calculadora de Ahorro</span>
                <h2 className="text-3xl  tracking-tight">Simula tus Ingresos y Ahorros</h2>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg  text-[#059669]">${servicePrice} USD</span>
                </div>
                <input
                  type="range"
                  min="10"
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg  text-[#059669]">{monthlyJobs} servicios</span>
                </div>
                <input
                  type="range"
                  min="5"
            ...
            <div className="bg-[#059669] text-white p-8 lg:p-12 lg:col-span-5 flex flex-col justify-between space-y-8">
              <div className="space-y-6">
                <h3 className="text-xl  border-b border-white/20 pb-4">Tus Ganancias Estimadas</h3>

                <div className="space-y-1">
                  <span className="text-xs text-white/75 block">Facturación Mensual Total</span>
                  <span className="text-3xl ">${totalRevenue.toLocaleString()} USD</span>
                </div>

                <div className="space-y-1">
                  <span className="text-xs text-white/75 block">Comisión típica en otras Apps (20%)</span>
                  <span className="text-lg  text-white/80 line-through">${standardCommission.toLocaleString()} USD</span>
                </div>
                ...
                <div className="border-t border-white/20 pt-4 space-y-1">
                  ...
                  <span className="text-4xl  text-white">${GestiEarnings.toLocaleString()} USD</span>
                </div>
              </div>

              <div className="bg-white/10 p-4 rounded-lg space-y-1">
                <span className="text-xs text-white/80  block uppercase tracking-wider">Tu Ahorro Neto Mensual</span>
                <span className="text-2xl  text-white">+${monthlySavings.toLocaleString()} USD</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <span className="text-xs  uppercase tracking-wider text-[#059669]">¿Por qué elegir Gesti?</span>
            <h2 className="text-3xl md:text-4xl  tracking-tight">Diseñado específicamente para profesionales independientes</h2>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className=" text-base">Independencia Absoluta</h4>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className=" text-base">Sin Competencia Directa en tu Perfil</h4>
          ...
          <div className="bg-muted/30 border border-border p-8 rounded-2xl space-y-6">
            <h3 className=" text-lg">Lo que dicen otros proveedores</h3>
            ...
            <div className="p-6 bg-card border border-border rounded-xl space-y-4 shadow-sm">
              ...
              <div>
                <p className=" text-sm">Carlos Rosales</p>
            ...
            <div className="p-6 bg-card border border-border rounded-xl space-y-4 shadow-sm">
              ...
              <div>
                <p className=" text-sm">Diana Valenzuela</p>
        ...
        <section id="faqs" className="container mx-auto px-8 max-w-3xl space-y-8">
          <div className="text-center space-y-3">
            <h2 className="text-3xl  tracking-tight">Preguntas Frecuentes</h2>
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="py-4">
                <button
                  ...
                  className="w-full flex justify-between items-center text-left py-2  text-base hover:text-[#059669] transition-colors"
                >
                  <span>{faq.q}</span>
        ...
        <section className="container mx-auto px-8">
          <div className="bg-[#059669] text-white p-8 md:p-16 rounded-2xl text-center space-y-6 relative overflow-hidden">
            ...
            <h2 className="text-3xl md:text-5xl  tracking-tight max-w-3xl mx-auto">
            ...
            <div className="pt-4">
              <Link
                to={isAuthenticated ? "/services" : "/register"}
                className="inline-block py-3.5 px-8 bg-white text-black hover:bg-gray-100  rounded-lg shadow-lg transition-all text-base"
              >
